...
// pins definition MODIFIKOVANO ABY CHODIL UART 3
#define GSM_ON              32//8 // connect GSM Module turn ON to pin 77 
#define GSM_RESET           33//9 // connect GSM Module RESET to pin 35
...
public:
     ...
     int GetSignalStatus(char *answer);
